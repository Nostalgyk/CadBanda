...
namespace CadBandas
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        private void Inserir()
        {
            ...
            {
                lblRetornoOperacao.Text = "Falha ao inserir dados. {Erro Original: " + ex.Message + "}";
                lblRetornoOperacao.ForeColor = System.Drawing.Color.Red;
                return;
            }
        }
        ...
        private void Alterar(GridViewRow linhaSelecionada)
        {
            ...
            {
                lblRetornoOperacao.Text = "Falha ao alterar os dados. Erro original {" + ex.Message + "}";
                lblRetornoOperacao.ForeColor = System.Drawing.Color.Red;
                return;
            }
        }
        ...
        private void Excluir(GridViewRow linhaSelecionada)
        {
            ...
            {
                lblRetornoOperacao.Text = "Falha ao excluir os dados. Erro Original {" + ex.Message + "}";
                lblRetornoOperacao.ForeColor = System.Drawing.Color.Red;
                return;
            }
        }
